...
def build_detector(in_channels, inner_channels, out_channels, scale, num_convs, drop_rate):
    return Conv3x3BNReLUs(in_channels, inner_channels, out_channels, scale, num_convs, drop_rate)
